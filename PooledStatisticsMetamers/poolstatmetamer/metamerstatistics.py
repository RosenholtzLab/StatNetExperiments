...
#        self.category_weights = { 'mean':6, 'variance':2, 'skew':2, 'kurtosis':2, 'bandpass_variance':10, 
#                                 'autocorrelation':1, 
#                                 'edge_mean':20, 'edge_variance':80, 'edge_kurtosis':400, 
#                                 'edge_autocorrelation':5, 'edge_correlation':40, 'edge_stop':40, #'edge_continue':80,
...
#        self.stat_high_variance_to_zero = False       # Not actually a statistic, but option to try to force high-pass to zero in metamer
        ...
        self.stat_edge_stop = True #das geändert
        ...
        self.named_stat_groups = { 
                ...
                # Additional categories from Vasha and Anne
                 'edge_stop_stats':('edge_stop',),
                 'phase_corr_stats':('phase_scalecorrelation',),
                 'phase_corr_edge_stop_stats':('phase_scalecorrelation','edge_stop'),
                 'brown_default_stats':('mean','base_variance','bandpass_variance','low_variance','low_skewkurtosis', 'edge_mean','edge_variance','edge_orientationcorrelation','edge_scalecorrelation','edge_stop','phase_orientationcorrelation','phase_scalecorrelation'),
                #'brown_default_stats_nosk':('mean','base_variance','bandpass_variance','low_variance', 'edge_mean','edge_variance','edge_orientationcorrelation','edge_scalecorrelation','edge_stop','phase_orientationcorrelation','phase_scalecorrelation'),
                'brown_default_stats_minus_edgestop':('mean','base_variance','bandpass_variance','low_variance', 'low_skewkurtosis','edge_mean','edge_variance','edge_orientationcorrelation','edge_scalecorrelation','phase_orientationcorrelation','phase_scalecorrelation'),
                'brown_default_stats_minus_edge_corr':('mean','base_variance','bandpass_variance','low_variance', 'low_skewkurtosis','edge_mean','edge_variance','edge_stop','phase_orientationcorrelation','phase_scalecorrelation'),
                'brown_default_stats_minus_phase_corr':('mean','base_variance','bandpass_variance','low_variance','low_skewkurtosis', 'edge_mean','edge_variance','edge_orientationcorrelation','edge_scalecorrelation','edge_stop'),
                'brown_default_stats_minus_edge_mean':('mean','base_variance','bandpass_variance','low_variance', 'low_skewkurtosis','edge_variance','edge_orientationcorrelation','edge_scalecorrelation','edge_stop', 'phase_orientationcorrelation','phase_scalecorrelation'),
                'brown_default_stats_minus_varianceco':('mean','bandpass_variance','edge_mean' ,'edge_variance','edge_orientationcorrelation','edge_scalecorrelation','edge_stop', 'phase_orientationcorrelation','phase_scalecorrelation'),
                'brown_default_stats_minus_bandvariance':('mean', 'base_variance', 'low_variance','low_skewkurtosis', 'edge_mean','edge_variance','edge_orientationcorrelation','edge_scalecorrelation','edge_stop', 'phase_orientationcorrelation','phase_scalecorrelation'),
            'heegerbergen':('mean','base_variance','bandpass_variance','low_variance','low_skewkurtosis', 'edge_mean', 'edge_variance'),
            'brown_default_stats_plus_':('mean','base_variance','bandpass_variance','low_variance','low_skewkurtosis', 'edge_mean','edge_variance','edge_orientationcorrelation','edge_scalecorrelation','edge_stop','phase_orientationcorrelation','phase_scalecorrelation'),
                }
